...
@Configuration
class AdvertisingActivationBatchJobConfig(
    private val jobRepository: JobRepository,
    private val transactionManager: PlatformTransactionManager,
    @Qualifier("advertisingActivationItemReader") private val advertisingItemReader: ItemReader<Advertising>,
    @Qualifier("advertisingActivationItemProcessor") private val advertisingItemProcessor: ItemProcessor<Advertising, Advertising>,
    @Qualifier("advertisingActivationItemWriter") private val advertisingItemWriter: ItemWriter<Advertising>
) {
